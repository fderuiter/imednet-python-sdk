...
.. list-table::
   ...
   * - Breaking changes
     - Medium
     - High
     - Extensive testing, feature flags
   ...
   * - Incomplete refactoring
     - High
     - Low
     - Incremental approach, version control
...
- `SOLID Principles <https://en.wikipedia.org/wiki/SOLID>`_
- `DRY Principle <https://en.wikipedia.org/wiki/Don%27t_repeat_yourself>`_
- `Refactoring Catalog <https://refactoring.com/catalog/>`_
