"""
Mixins for ImednetSDK to separate concerns and improve modularity.
"""
...
if TYPE_CHECKING:
    ...
    class SDKProtocol(Protocol):
        """Protocol defining the dependencies required by SDKConvenienceMixin."""
...
class SDKConvenienceMixin:
    """
    Mixin providing convenience methods for common SDK operations.

    These methods wrap underlying endpoint calls to provide a flatter API surface.
    """
    ...
    def get_users(
        self: SDKProtocol, study_key: str, include_inactive: bool = False
    ) -> List[User]:
