"""
Mixin for SDK convenience methods.

This module houses the high-level methods that delegate to specific endpoints,
keeping the main SDK class focused on configuration and initialization.
"""
...
class SDKConvenienceMixin:
    """
    Mixin class containing convenience wrappers around common endpoint methods.
    """

    # Type hints for endpoints expected to be present on the main class
