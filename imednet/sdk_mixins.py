...
class SDKConvenienceMixin:
    """
    Mixin providing convenience wrappers around common endpoint methods.

    This mixin is intended to be used by the main ImednetSDK class.
    It delegates calls to the specific endpoint instances attached to the SDK.
    """

    # Type hints for the expected attributes on the consuming class
    if TYPE_CHECKING:
