...
class HTTPClientBase(BaseClient):
    ...
    def __init__(
        ...
        # The executor handles retry logic and monitoring.
        # We pass self._send to allow dynamic dispatch, enabling monkeypatching
        # of self._client.request in tests.
    ...
    def _send(self, method: str, url: str, **kwargs: Any) -> Any:
        ...
        # This method delegates to the appropriate sync or async client method.
        # Subclasses (Client, AsyncClient) must implement this to handle
        # the specific return type (Response vs Awaitable[Response]).
