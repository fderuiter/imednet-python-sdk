...
class CachedEndpointMixin(Generic[T]):
    ...
    This mixin intercepts list operations to return cached results
    when applicable, and updates the cache on fresh fetches.
    """
    ...
    def _list_sync(
        ...
        **filters: Any,
        ...
        param_state = getattr(self, "_resolve_params")(study_key, extra_params, filters)
        ...
        # Call the next implementation in the MRO (e.g., GenericListGetEndpoint._list_sync)
        result = super()._list_sync(  # type: ignore[misc]
            client,
            paginator_cls,
            study_key=study_key,
            refresh=refresh,
    ...
    async def _list_async(
        ...
        **filters: Any,
        ...
        result = await super()._list_async(  # type: ignore[misc]
            client,
            paginator_cls,
            study_key=study_key,
            refresh=refresh,
