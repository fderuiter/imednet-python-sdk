...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'packages', 'plugins-sinks', 'src')))

# Instrument the code for coverage
with atheris.instrument_imports():
    import imednet
    import imednet_sinks
    from imednet.models.engine import load_schemas, _CACHE
