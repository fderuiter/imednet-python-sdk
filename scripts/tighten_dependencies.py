...
def main():
    ...
    parser.add_argument("--rewrite", action="store_true", help="Rewrite pyproject.toml files to use tight bounds")
    parser.add_argument("--restore", action="store_true", help="Restore pyproject.toml files from backups")
