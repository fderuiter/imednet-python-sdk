...
def test_filter_get_operation_returns_first_result():
    """Test that filter get operation returns first result."""
...
async def test_filter_get_operation_async_missing_callable():
    """Test that filter get operation async missing callable asynchronously."""
    operation = FilterGetOperation(
        study_key="STUDY",
        item_id=123,
        filters={"id": 123},
...
def test_path_get_operation_not_found_callback():
    """Test that path get operation not found callback."""
    client = MagicMock()
    response = MagicMock()
    ...
    def raise_not_found() -> None:
        """Helper function to raise not found."""
...
def test_path_get_operation_calls_parse_func():
    """Test that path get operation calls parse func."""
    client = MagicMock()
    response = MagicMock()
