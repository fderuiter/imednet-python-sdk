...
@patch("imednet.endpoints.visits.Paginator")
@patch("imednet.endpoints.visits.Visit")
def test_list_with_only_study_key(mock_visit, mock_paginator, mock_endpoint):
...
@patch("imednet.endpoints.visits.Paginator")
@patch("imednet.endpoints.visits.Visit")
def test_list_uses_default_study_key(mock_visit, mock_paginator, mock_endpoint):
    mock_paginator.return_value = [{"id": 1}]
    mock_visit.from_json.side_effect = lambda x: x
