...
def test_no_endpoint_directly_inherits_edc_mixin():
    ...
    for endpoint_cls in ALL_ENDPOINT_CLASSES:
        direct_base_names = {b.__name__ for b in endpoint_cls.__bases__ if not b.__name__.endswith("OperationDef")}
...
def test_all_async_endpoints_inherit_from_single_edc_base():
    ...
    for endpoint_cls in ALL_ASYNC_ENDPOINT_CLASSES:
        base_names = {b.__name__ for b in endpoint_cls.__bases__ if not b.__name__.endswith("OperationDef")}
