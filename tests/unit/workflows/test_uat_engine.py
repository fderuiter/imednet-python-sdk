...
def test_generate_negative_test_case_all_branches():
    ...
    # Dependency branches
    assert engine.generate_negative_test_case({"variable": "V1", "dependency_variable": "D1", "dependency_value": "Yes", "operator": "=="}) == {"D1": "Yes", "V1": "NOT_None"}
    assert engine.generate_negative_test_case({"variable": "V1", "dependency_variable": "D1", "dependency_value": "Yes", "operator": "!=", "value": "A"}) == {"D1": "Yes", "V1": "A"}
    assert engine.generate_negative_test_case({"variable": "V1", "dependency_variable": "D1", "dependency_value": "Yes", "operator": ">="}) == {"D1": "Yes", "V1": "Invalid_Value"}
    
    # Non-dependency branches
    assert engine.generate_negative_test_case({"variable": "V1", "operator": "<=", "value": "10"}) == {"V1": "11.0"}
    assert engine.generate_negative_test_case({"variable": "V1", "operator": "<=", "value": "BAD"}) == {"V1": "9999"}
    assert engine.generate_negative_test_case({"variable": "V1", "operator": ">=", "value": "BAD"}) == {"V1": "0"}
    assert engine.generate_negative_test_case({"variable": "V1", "operator": "==", "value": "X"}) == {"V1": "NOT_X"}
    assert engine.generate_negative_test_case({"variable": "V1", "operator": "!=", "value": "X"}) == {"V1": "X"}
    assert engine.generate_negative_test_case({"variable": "V1", "operator": "Required"}) == {"V1": ""}
    assert engine.generate_negative_test_case({"variable": "V1", "operator": "OTHER"}) == {"V1": "Invalid_Test_Value"}
