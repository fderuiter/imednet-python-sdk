"""Unit tests for components charts."""
...
def test_bar_chart_returns_altair_chart_with_defaults() -> None:
    """Test that bar chart returns altair chart with defaults."""
...
def test_bar_chart_returns_altair_chart_with_color_encoding() -> None:
    """Test that bar chart returns altair chart with color encoding."""
...
def test_line_chart_returns_altair_chart_with_defaults() -> None:
    """Test that line chart returns altair chart with defaults."""
    df = pd.DataFrame(
        {
...
def test_line_chart_returns_altair_chart_with_color_encoding() -> None:
    """Test that line chart returns altair chart with color encoding."""
    df = pd.DataFrame(
        {
            "date": pd.to_datetime(["2026-01-01", "2026-01-02"]),
            "count": [1, 2],
...
def test_pie_chart_returns_altair_chart() -> None:
    """Test that pie chart returns altair chart."""
