...
def test_process_dependency():
    internal_pkgs = {
        "imednet": {"version": "0.8.0"},
        "imednet-workflows": {"version": "0.6.0"}
    }
    assert td.process_dependency("imednet", internal_pkgs) == "imednet>=0.8.0,<0.9.0"
    assert td.process_dependency("imednet[cli]>=0.8.0,<1.0.0", internal_pkgs) == "imednet[cli]>=0.8.0,<0.9.0"
    ...
    assert td.process_dependency("imednet-workflows>=0.5", internal_pkgs) == "imednet-workflows>=0.5,<0.7.0"
...
""")
    ...
    internal_pkgs = {
        "imednet": {"version": "0.8.0", "pyproject_path": pyproject}
    }
