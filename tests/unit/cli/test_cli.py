...
def test_missing_env_vars(runner: CliRunner, monkeypatch: pytest.MonkeyPatch) -> None:
    """Test the test missing env vars functionality."""
...
def test_studies_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test studies list success functionality."""
    obj = MagicMock()
...
def test_studies_list_api_error(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test studies list api error functionality."""
...
def test_sdk_closed_after_command(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test sdk closed after command functionality."""
...
def test_multiple_invocations_close_sdk(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test multiple invocations close sdk functionality."""
    sdk.studies.list.return_value = []
...
def test_sites_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test sites list success functionality."""
    obj = MagicMock()
    obj.site_id = "site1"
...
def test_subjects_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test subjects list success functionality."""
...
def test_subjects_list_invalid_filter(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test subjects list invalid filter functionality."""
...
def test_subjects_list_api_error(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test subjects list api error functionality."""
...
def test_extract_records_calls_workflow(
    ...
    """Test the test extract records calls workflow functionality."""
    workflow = MagicMock()
    monkeypatch.setattr(
...
def test_records_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test records list success functionality."""
    rec = MagicMock()
    rec.record_id = 1
    rec.subject_key = "S1"
    rec.form_key = "F1"
...
def test_records_list_output_csv(
    ...
    """Test the test records list output csv functionality."""
    rec = MagicMock()
...
def test_records_list_output_json(
    ...
    """Test the test records list output json functionality."""
    rec = MagicMock()
    rec.model_dump.return_value = {"recordId": 1}
    sdk.records.list.return_value = [rec]
    monkeypatch.chdir(tmp_path)
...
def test_records_list_no_records(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test records list no records functionality."""
...
def test_records_list_invalid_output(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test records list invalid output functionality."""
...
def test_records_list_api_error(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test records list api error functionality."""
...
def test_export_parquet_calls_helper(
    ...
    """Test the test export parquet calls helper functionality."""
    func = MagicMock()
...
def test_export_csv_calls_helper(
    ...
    """Test the test export csv calls helper functionality."""
    func = MagicMock()
...
def test_export_excel_calls_helper(
    ...
    """Test the test export excel calls helper functionality."""
    func = MagicMock()
...
def test_export_json_calls_helper(
    ...
    """Test the test export json calls helper functionality."""
    func = MagicMock()
...
def test_export_duckdb_calls_helper(
    ...
    """Test the test export duckdb calls helper functionality."""
    func = MagicMock()
...
def test_export_duckdb_help(runner: CliRunner) -> None:
    """Test the test export duckdb help functionality."""
...
def test_export_sql_calls_helper_non_sqlite(
    ...
    """Test the test export sql calls helper non sqlite functionality."""
    func = MagicMock()
    form_func = MagicMock()
...
def test_export_sql_sqlite_uses_by_form(
    ...
    """Test the test export sql sqlite uses by form functionality."""
    form_func = MagicMock()
    sql_func = MagicMock()
    monkeypatch.setattr(export_mod, "export_to_sql_by_form", form_func)
...
def test_export_sql_sqlite_single_table(
    ...
    """Test the test export sql sqlite single table functionality."""
    form_func = MagicMock()
    single = ["--single-table"]
    sql_func = MagicMock()
    monkeypatch.setattr(export_mod, "export_to_sql_by_form", form_func)
...
def test_export_sql_long_format(
    ...
    """Test the test export sql long format functionality."""
    long_func = MagicMock()
    form_func = MagicMock()
    sql_func = MagicMock()
...
def test_export_sql_long_format_overrides_single(
    ...
    """Test the test export sql long format overrides single functionality."""
    long_func = MagicMock()
    form_func = MagicMock()
    sql_func = MagicMock()
    monkeypatch.setattr(export_mod, "export_to_long_sql", long_func)
...
def test_export_parquet_missing_pyarrow(runner: CliRunner, monkeypatch: pytest.MonkeyPatch) -> None:
    """Test the test export parquet missing pyarrow functionality."""
...
def test_export_sql_missing_sqlalchemy(runner: CliRunner, monkeypatch: pytest.MonkeyPatch) -> None:
    """Test the test export sql missing sqlalchemy functionality."""
    original_find_spec = importlib.util.find_spec
...
def test_export_duckdb_missing_dependency(
    ...
    """Test the test export duckdb missing dependency functionality."""
    original_find_spec = importlib.util.find_spec
...
def test_subject_data_calls_workflow(
    ...
    """Test the test subject data calls workflow functionality."""
    workflow = MagicMock()
    monkeypatch.setattr(
...
def test_sync_worker_once_command(
    ...
    """Test the test sync worker once command functionality."""
    worker = MagicMock()
...
def test_sync_worker_command_handles_keyboard_interrupt(
    ...
    """Test the test sync worker command handles keyboard interrupt functionality."""
    worker = MagicMock()
...
def test_queries_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test queries list success functionality."""
    obj = MagicMock()
    obj.description = "Q1"
...
def test_queries_list_empty(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test queries list empty functionality."""
...
def test_variables_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test variables list success functionality."""
    obj = MagicMock()
...
def test_variables_list_empty(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test variables list empty functionality."""
...
def test_record_revisions_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test record revisions list success functionality."""
...
def test_record_revisions_list_empty(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test record revisions list empty functionality."""
...
def test_jobs_status_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test jobs status success functionality."""
...
def test_jobs_wait_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test jobs wait success functionality."""
...
def test_intervals_list_success(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test intervals list success functionality."""
    obj = MagicMock()
    obj.interval_id = 1
...
def test_intervals_list_empty(runner: CliRunner, sdk: MagicMock) -> None:
    """Test the test intervals list empty functionality."""
