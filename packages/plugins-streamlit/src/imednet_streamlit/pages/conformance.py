...
st.markdown("Welcome to the live-updating Accessibility Conformance Portal. "
...
if os.path.exists(vpat_path):
    with open(vpat_path, "rb") as f:
        st.download_button("Download VPAT / ACR", data=f.read(), file_name="VPAT.md", mime="text/markdown")
