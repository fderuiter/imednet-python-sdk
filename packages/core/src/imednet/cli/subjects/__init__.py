...
def setup_parser(subparsers):
    ...
    list_parser.add_argument("-f", "--filter", action="append", dest="subject_filter", help="Filter criteria (e.g., 'subject_status=Screened'). Repeat for multiple filters.")
    
    @with_sdk
    def list_subjects(sdk: ImednetSDK, study_key: str, subject_filter: list[str] | None = None) -> None:
    ...
    list_parser.set_defaults(func=lambda args: list_subjects(study_key=args.study_key, subject_filter=args.subject_filter))
