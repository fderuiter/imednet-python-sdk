...
def _get_from_path(value: Any, path: str) -> Any:
    """Handle the get from path process."""
    if not path:
        return None
    current = value
...
def _extract_rule_value_from_payload(
    ...
    """Handle the extract rule value from payload process."""
...
def _is_missing_value(value: Any) -> bool:
    """Handle the is missing value process."""
...
def _group_mappings_by_domain_and_form(
    ...
    """Handle the group mappings by domain and form process."""
...
class SubjectContext:
    """Implementation of the SubjectContext class."""
...
def _evaluate_business_logic(
    ...
    """Handle the evaluate business logic process."""
    try:
        # evaluate safely
        env = {
            "record": record,
