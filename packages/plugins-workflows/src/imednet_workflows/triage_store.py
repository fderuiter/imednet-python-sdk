...
class TriageStore:
    ...
    def _connection(self) -> Iterator[sqlite3.Connection]:
        ...
        conn.execute(f"PRAGMA busy_timeout = {_SQLITE_BUSY_TIMEOUT_MS};")  # nosec B608  # nosemgrep
    ...
    def _initialize_schema(self) -> None:
        with self._connection() as conn:
            ...
            if current_version < _LATEST_SCHEMA_VERSION:
                ...
                conn.execute(f"PRAGMA user_version = {_LATEST_SCHEMA_VERSION}")  # nosec B608  # nosemgrep
            conn.commit()
